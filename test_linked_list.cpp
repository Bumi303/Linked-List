...
** Date: 12/4/22
** Description: this program lets the user manipulate linked lists
** Input: the user will input how to want to manipute the linked list
** Output: outputs the result of linked list manipulate
*********************************************************************/
...
/*********************************************************************
** Function: pause
** Description: pauses the program before continues
** Parameters: n/a
** Pre-Conditions: n/a
** Post-Conditions:  n/a
*********************************************************************/
...
/*********************************************************************
** Function: main
** Description: has all tests and directs to user choice
** Parameters: n/a
** Pre-Conditions: n/a
** Post-Conditions:  n/a
*********************************************************************/
